...
<head>
  ...
  <meta name="description" content="Meet Manoj Bhanot, a certified RYS 200 Yoga and Yoga Nidra instructor. Combining CrossFit discipline with mindfulness, he offers a dynamic balance of strength and calm." />
  ...
  <style>
      ...
      <?php require_once('partials/css/full-listing.php') ?>
        .hero-section{
            background-image: url('<?php echo $cdn_url ?>/media/teachers/2/cover-image.webp');
            height: 60vh;
    ...
    <div class="row">
      <div class="col col-xs-12 col-lg-3 col-1">
        <div class="profile-image">
          <img src="<?php echo $cdn_url ?>/media/teachers/2/profile-image.webp">
        </div>
      </div>
